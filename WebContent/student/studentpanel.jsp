...
.login:hover,.signup:hover,.home:hover{
...
<div class="back"></div>
<div class="box">
<form action="studloginaction.jsp" method="post">
<table class="tb1" align="center">
<caption>Student Login</caption>
<tr>
<th style="text-align:left;">Enter User-Id</th>
<th style="text-align:center;"><input autocomplete="off" class="usr" type="text" name="uid" placeholder="Enter Registration No." required>
</tr>
<tr>
