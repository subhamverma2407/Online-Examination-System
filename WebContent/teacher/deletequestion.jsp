...
try{
	...
	while(rs.next())
	{
		%>
		<div class="para">
		<form method="post" action="deletequestionaction.jsp">
		<table class="t1">
...
<input type="hidden" name="delete" value="<%=rs.getInt(1)%>">
</th>
</tr>
<tr>
<th colspan="2">
...
<tr>
<th colspan="2">
<input disabled required class="field" value="<%=rs.getString(7)%>" type="text">
</th>
</tr>
<tr>
<th colspan="2">
