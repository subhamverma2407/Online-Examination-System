...
<th style="text-align:center;"><input autocomplete="off" class="usr" type="text" name="aid" placeholder="Enter Admin-Id" required>
</tr>
<tr>
<th style="text-align:left;">Enter Password</th>
<th style="text-align:center;"><input class="pwd" type="password" name="apass" placeholder="Enter Password" required>
</tr>
<tr>
