...
<table class="t1" align="center">
		<tr>
		<th>
		<input disabled class="field1" value="Teacher Name" type="text">
		</th>
		<th>
		<input disabled class="field1" value="Teacher-ID" type="text">
		</th>
		<th>
...
try{
	...
	while(rs.next())
	{
		...
		{
		%>
		<form method="post" action="deleteteacheraction.jsp">
		<table class="t1" align="center">
<tr>
<th>
<input disabled required class="field" value="<%=rs.getString(1)%>" type="text" name="tname">
</th>
<th>
<input disabled required class="field" value="<%=rs.getString(2)%>" type="text" name="id">
</th>
<th>
<input class="submit" type="submit" value="Delete">
<input type="hidden" value="<%=rs.getString(2)%>" name="tid">
</th>
</tr>
</table>
		</form>
...
<tr>
<th>
<input disabled required class="field2" value="<%=rs.getString(1)%>" type="text" name="tname">
</th>
<th>
<input disabled required class="field2" value="<%=rs.getString(2)%>" type="text" name="id">
</th>
<th>
<input class="submit" type="submit" value="Delete">
<input type="hidden" value="<%=rs.getString(2)%>" name="tid">
