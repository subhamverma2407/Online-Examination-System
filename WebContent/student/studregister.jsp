...
<div class="back"></div>
<div class="box">
<form action="studregaction.jsp" method="post">
<table class="tb1" align="center">
<caption>Student Register</caption>
<tr>
...
<th style="text-align:right;"><input class="field" type="text" name="rn" placeholder="Enter Registration No." required>
</th>
</tr>
<tr>
...
<select class="field" name="br" required>
