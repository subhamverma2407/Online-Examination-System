...
try
{
	...
	if(rs.next())
	{
		if(rs.getInt(1)==0)
		{
			PreparedStatement ps1=con.prepareStatement("update exam set examstate=1");
			ps1.executeUpdate();
			
				%>
				<script>
				document.getElementById("validate").innerHTML="Exam Started";
				</script>
				<%
			...
			%>
			<script>
			document.getElementById("validate").innerHTML="Exam Already Started";
			</script>
			<%
			RequestDispatcher rd=request.getRequestDispatcher("exam.jsp");
			rd.include(request,response);
