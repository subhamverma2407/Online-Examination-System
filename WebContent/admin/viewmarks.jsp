...
<table class="t1" align="center">
		...
		<th>
		<input disabled style="width:80px;" class="field1" value="Branch" type="text">
		</th>
		<th>
		<input style="width:80px;" disabled class="field1" value="Result" type="text">
		</th>
		<th>
		<input disabled class="field1" value="Status" type="text">
		</th>
		</tr>
...
try{
	...
	PreparedStatement ps=con.prepareStatement("select * from student order by result desc");
...
<tr>
<th>
<input disabled required class="field" value="<%=rs.getString(1)%>" type="text">
</th>
<th>
<input disabled required class="field" value="<%=rs.getString(2)%>" type="text">
</th>
<th>
<input disabled style="width:80px;" required class="field" value="<%=rs.getString(4)%>" type="text">
</th>
<th>
<input disabled style="width:80px;" required class="field" value="<%=rs.getString(9)%>" type="text">
</th>
<th>
<input disabled required class="field" value="<%=status%>" type="text">
</th>
</tr>
</table>
		<br>
